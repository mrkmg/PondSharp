...
/* harmony export */   "O": () => /* binding */ PondRenderer
/* harmony export */ });
/* harmony import */ var pixi_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8244);

class PondRenderer {
    constructor(element, width, height, gridSize) {
        this.entities = {};
        ...
        this.application = new pixi_js__WEBPACK_IMPORTED_MODULE_0__/* .Application */ .Mx({
        ...
        this.fps = new pixi_js__WEBPACK_IMPORTED_MODULE_0__/* .Text */ .xv("FPS: ??", { fill: 0xAAFFAA, fontSize: 8 });
    ...
    createEntity(id, x, y, color) {
        const graphic = new pixi_js__WEBPACK_IMPORTED_MODULE_0__/* .Graphics */ .TC();
    ...
    processEntityChangeRequests(requests) {
    ...
    onTick() {
        this.fps.text = `FPS: ${Math.round(pixi_js__WEBPACK_IMPORTED_MODULE_0__/* .Ticker.shared.FPS */ .vB.shared.FPS)}`;
    }
}
